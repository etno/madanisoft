...
var styleSwitcher = {
    init: function () {
        ...
        yepnope([
        {
            load: '../css/style-switcher.css'
        },
        {
            load: '../lib/colorpicker/css/colorpicker.css'
        },
        {
            load: '../lib/cssbeautify/cssbeautify.js'
        },
        {
            load: '../lib/colorpicker/js/bootstrap-colorpicker.js',
            complete: function () {
                yepnope([
                {
                    load: 'less!../less/theme.less'
                },
                {
                    load: '../lib/less-1.5.1.min.js',
                    complete: function () {
                        $this.build();
    ...
    build: function () {
        ...
        if (localStor) {
            ...
            if (localStorage.pattern) {
                $('body') .css({
                    'background': 'url(./img/pattern/' + localStorage.pattern + '.png) repeat'
                });
            }
        }
