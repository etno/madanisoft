                ...
                <tr>
                  ...
                  <th>
                      <select name="status" id="status_filter" class='select2 form-control'>
                        ...
                        ?>
                          <option value="<?=$key?>" <?=($key==$filter['group_status'])?'selected':''?> ><?=ucwords($key)?></option>
                        <?
                          }
                        ?>
                      </select>
            ...
            <tbody>
              ...
              ?>
                    <tr>
                      ...
                      <td align="center">
                        <button class="btn btn-xs btn-<?=$status[$group_name->group_status]?>"><?=ucwords($group_name->group_status)?></button>
                      </td>
                      <td class=" ">
...
<script room="text/javascript">
  ...
  function editing_data (room_id) {
    ...
    $.post(post_path,null, function(data){
      ...
      $("#status").val(obj.group_lists.group_status);
    });
