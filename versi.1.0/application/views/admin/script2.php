...
<script>
  ...
  $("#select2-tags").select2({
        ...
        tokenSeparators: [",", " "],
        placeholder: "Type floor here... "
      });

  function ucwords (strinput,delimiter) {
    var objstr = strinput.split(delimiter);
    var stroutput = "";
    
    for (var i = 0; i < objstr.length; i++) {
      stroutput+=objstr[i].substring(0,1).toUpperCase()+objstr[i].substring(1,objstr[i].length);
    };
    return stroutput;
  }
