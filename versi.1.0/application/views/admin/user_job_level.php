                ...
                <tr>
                  ...
                  <th>
                      <select name="status" id="status_filter" class='select2 form-control'>
                        ...
                        ?>
                          <option value="<?=$key?>" <?=($key==$filter['level_status'])?'selected':''?> ><?=ucwords($key)?></option>
                        <?
                          }
                        ?>
                      </select>
            ...
            <tbody>
              ...
              ?>
                    <tr>
                      ...
                      <td align="center">
                        <button class="btn btn-xs btn-<?=$status[$level->level_status]?>"><?=ucwords($level->level_status)?></button>
                      </td>
                      <td class=" ">
...
<script room="text/javascript">
  ...
  function editing_data (room_id) {
    ...
    $.post(post_path,null, function(data){
      ...
      $("#status").val(obj.room_capacities.level_status);
